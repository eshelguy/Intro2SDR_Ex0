...
class Ex0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ex0")
        ...
        self.freq_slider = freq_slider = 91.6e6
        ...
        self._freq_slider_range = qtgui.Range(88e6, 108e6, 0.1e6, 91.6e6, 200)
        ...
        self.rtlsdr_source_0.set_sample_rate(2.112e6)
        self.rtlsdr_source_0.set_center_freq(freq_slider, 0)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/eshel/Desktop/intro2SDR/ex0-audio',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
    ...
    def set_freq_slider(self, freq_slider):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq_slider, self.samp_rate)
        self.rtlsdr_source_0.set_center_freq(self.freq_slider, 0)
...
def main(top_block_cls=Ex0, options=None):
